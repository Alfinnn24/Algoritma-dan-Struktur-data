...
public class BangunRuang16 {
    ...
    static void inputKerucut() {
        ...
        Kerucut16[] krctArray = new Kerucut16[k];
        ...
        for (int i = 0; i < k; i++) {
            ...
            krctArray[i] = new Kerucut16(jj, sm);
    ...
    static void inputLimas() {
        ...
        LimasSegiEmpat16[] lmsArray = new LimasSegiEmpat16[k];
        ...
        for (int i = 0; i < k; i++) {
            ...
            lmsArray[i] = new LimasSegiEmpat16(psa, tl);
